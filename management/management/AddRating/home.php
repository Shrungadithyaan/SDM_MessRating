...
<body style="background-color:#ececec">
  ...
  <div class="back-button">
    <a href="../../activity_list.php" onclick="history.back(); return false;">
      Home
    </a>
  </div>
  <div class="centerer" style="margin-top:150px">
    ...
    <div align="center">
      ...
      <a style="text-decoration: none;" class="button-33" href="student_menu.php?value=Breakfast">Breakfast</a>
      <a style="text-decoration: none;" class="button-33" href="student_menu.php?value=Lunch">Lunch</a>
      <a style="text-decoration: none;" class="button-33" href="student_menu.php?value=Snack">Snacks</a>
      <a style="text-decoration: none;" class="button-33" href="student_menu.php?value=Dinner">Dinner</a>
