                ...
                <center>
                    ...
                    <center>
                        ...
                        <div class="tables">
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color:white;color:grey;font-family:Raleway, sans-serif;">HOSTEL NAME</th>
                                        <th style="background-color:white;color:grey;font-family:Raleway, sans-serif;">ROLE</th>
                                        <th style="background-color:white;color:grey;font-family:Raleway, sans-serif;">DATE AND TIME
                                        </th>
                            ...
                            <td style='margin-right:20px;font-family:Raleway, sans-serif;'>" . $row['timestamp'] . "</td>";
                                    }
                                }
