                ...
                <center>
                    ...
                    <center>
                        ...
                        <div class="tables">
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color:white;color:grey;font-family:Raleway, sans-serif;">ROLL NUMBER
                                        </th>
                                        <th style="background-color:white;color:grey;font-family:Raleway, sans-serif;">ROLE
                                        </th>
                                        <th style="background-color:white;color:grey;font-family:Raleway, sans-serif;">CATEGORY</th>
                                        <th style="background-color:white;color:grey;font-family:Raleway, sans-serif;">FOOD NAME
                                        </th>
                                        <th style="background-color:white;color:grey;font-family:Raleway, sans-serif;">COOK NAME
                                        </th>
                            ...
                            <td style='margin-right:20px;font-family:Raleway, sans-serif;'>" . $count . "</td>
                            <td style='margin-right:20px;font-family:Raleway, sans-serif;'>" . $row['hostel_name'] . "</td>
                            <td style='margin-right:20px;font-family:Raleway, sans-serif;'>" . $row['name'] . "</td>
                            <td style='margin-right:20px;font-family:Raleway, sans-serif;'>" . $row['role'] . "</td>
                            <td style='margin-right:20px;font-family:Raleway, sans-serif;'>" . $row['category'] . "</td>
                            <td style='margin-right:20px;font-family:Raleway, sans-serif;'>" . $row['food_item'] . "</td>
                            <td style='margin-right:20px;font-family:Raleway, sans-serif;'>" . $row['cook_name'] . "</td>
                            <td style='margin-right:20px;font-family:Raleway, sans-serif;'>" . $row['rating'] . "</td>
