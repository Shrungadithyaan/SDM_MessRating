...
<body>
    ...
    <h2 align="center" style="font-family:sans-serif; margin-top:7%">Hostel Name : <?php echo $_SESSION['hostel_name_display'] ?></h2>
    <div class="container">

        <h3 align="center" style="font-family:sans-serif;"><u>View Review</u></h3>
        <br />
